	...
	<div id="commande">
		...
		<div id="attaque">
			<div id="attaque1">
				...
				while ($ligne = mysqli_fetch_assoc($att1)) {
					...
					echo $ligne['Nom_Type'];
					echo "<p id='pp'>PP   ".$ligne['PP_att1']."/".$ligne['PP_Attaque']."</p>";
				}
				?>
			</div>
			<div id="attaque2">
			...
			<div id="attaque3">
				...
				while ($ligne = mysqli_fetch_assoc($att3)) {
					echo "<p id='nomAttaque'>".$ligne['Nom_Attaque']."</p>";
					echo $ligne['Nom_Type'];
					echo "<p id='pp'>PP   ".$ligne['PP_att3']."/".$ligne['PP_Attaque']."</p>";
				}
				?>
			</div>
			<div id="attaque4">
				...
				while ($ligne = mysqli_fetch_assoc($att4)) {
					echo "<p id='nomAttaque'>".$ligne['Nom_Attaque']."</p>";
					echo $ligne['Nom_Type'];
					echo "<p id='pp'>PP   ".$ligne['PP_att4']."/".$ligne['PP_Attaque']."</p>";
				}
				?>
			</div>
		...
		<div id="sac">
			...
			<div id="ball">
				...
				?>
				<button class="retourball" id="retour" type="button" >&#8618;</button>
			</div>
			<div id="soins">
				<?php
				$i = 1;
