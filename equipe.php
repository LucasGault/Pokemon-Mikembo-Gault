...
$equipe = mysqli_query($link,'SELECT * FROM equipe INNER JOIN pokemon	WHERE equipe.Numero = pokemon.Numero AND id_membre = '. intval($_SESSION['id']) . ' ORDER BY Place_Equipe ASC');
